<?php echo $this->Form->create($order['Order']['amount']); ?>
<!-- <form id="RecipeEditForm" method="post" action="_method">
<input type="hidden" name="_method" value="PUT" />
<select name="_method"><?php echo $this->Form->select('creation_date', $dates);  ?></select>
<input type="submit" value="Submit">

<?php echo $myform; ?>
<form action='creation_date' method="GET">
<option value=<?php echo $this->Form->select('creation_date', $dates);  ?>

</select>
</form>


   <?php echo $this->Form->select('creation_date', $dates);  ?>
	<input type="submit" value="Submit">
</form> -->
	<!-- <?php echo ("Chosen Day: ".$name);?>
